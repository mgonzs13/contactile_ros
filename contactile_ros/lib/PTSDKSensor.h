...
/** \brief The PTSDKSensor class describes a PapillArray Tactile Sensor
 * comprised of multiple pillars.
 *
 * The PTSDKSensor class describes a PapillArray sensor comprised of multiple
 * pillars.
 *
...
private:
  ...
  void addSensorSample(IN const float globalForceVals[NDIM],
                       IN const float globalTorqueVals[NDIM],
                       IN const uint64_t timestamp_us);
