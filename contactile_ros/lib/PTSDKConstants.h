...
#define MAX_NSENSOR                                                            \
  20 // The maximum number of sensors connected to the communication hub
...
#define LOG_BUF_LEN                                                            \
  5000 // Length of the log file data buffer - the maximum number of bytes in a
       // single line of the log file
#define LOG_FILENAME_LEN                                                       \
  200 // Length of the log filename buffer - the maximum number of characters in
      // the log filename

#define DISPLACEMENT_IND                                                       \
  0 // Displacement measurement - used to unpack calibration file
#define FORCE_IND 1 // Force measurement - used to unpack calibration file
#define NMEASUREMENT                                                           \
  2 // Number of measurements - used to unpack calibration file
